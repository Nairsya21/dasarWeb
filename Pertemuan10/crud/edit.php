        ...
        <form action="proses.php?aksi=ubah" method="post">
            ...
            <div class="form-group">
                ...
                <div class="form-check">
                    <input type="radio" class="form-check-input"name="jenis-kelamin" value="L" id="laki" <?php if ($row['jenis_kelamin'] === 'L') echo 'checked'; ?> required>
                    <label class="form-check-label" for="laki">Laki-laki</label>
                </div>
                <div class="form-check">
                    <input type="radio" class="form-check-input"name="jenis-kelamin" value="P" id="perepmpuan" <?php if ($row['jenis_kelamin'] === 'P') echo 'checked'; ?> required>
